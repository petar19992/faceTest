...
public class GraphicOverlay extends View {
    ...
    public static abstract class Graphic {
        ...
        public Graphic(GraphicOverlay overlay) {
            mOverlay = overlay; //OVDE MOGU DA GA INKREMENTIRAM
            BROJAC++;
        }
    ...
    public void remove(Graphic graphic) {
        synchronized (mLock) {
            mGraphics.remove(graphic); //OVDE MOGU DA DEKREMENTIRAM BROJAC
            BROJAC--;
            Toast.makeText(getContext(), mGraphics.size(), Toast.LENGTH_SHORT).show();
            Log.i("TAG", ""+mGraphics.size());
        }
        postInvalidate();
    }
